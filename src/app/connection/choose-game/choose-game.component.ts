import {AfterViewInit, Component, DoCheck, EventEmitter, Output, ViewChild} from '@angular/core';
...
export class ChooseGameComponent implements AfterViewInit, DoCheck {
  ...
  joinGame(game: string, deck?: Deck): void {
    this.joinGameRequest.emit({game, deck});
  }

  addComPlayerToFfaGame(): void {
    this.websocketService.addComToGame();
  }

  forceStartFfaGame(): void {
